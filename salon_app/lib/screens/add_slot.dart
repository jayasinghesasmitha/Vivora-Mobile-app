    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text('Add New Slot', style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.bold)),
            ...
            Center(
              child: ElevatedButton(
                ...
                child: const Text('Save Slot', style: TextStyle(color: Colors.black)),
              ),
            ),
          ],
        ),
